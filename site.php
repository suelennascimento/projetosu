...
$app->get("/dados/:desurl", function($desurl){
...
User::getDados($_POST['nome'], $_POST['email'],$_POST['avaliacao']);
...
/*$app->get("/dadosenvia", function($email){
